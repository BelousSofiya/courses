...
def findPermutation(p, q):
    return [e+1 for i in range(len(q)) for e in range(len(p)) if q[i] == p[e]]
...
print(findPermutation(p, q))
#Expect [93, 57, 9, 29, 96, 69, 100, 35, 92, 89, 95, 41, 85, 32, 42, 61, 47, 65, 49, 7, 23, 55, 70, 98, 53, 87, 18, 76,
# 13, 11, 60, 59, 90, 79, 25, 56, 68, 31, 19, 26, 58, 39, 84, 4, 17, 24, 22, 40, 6, 1, 67, 88, 74, 3, 73, 5, 62, 72, 52,
# 54, 46, 81, 91, 75, 14, 15, 12, 77, 20, 38, 21, 83, 44, 34, 97, 80, 63, 2, 50, 94, 51, 99, 27, 36, 48, 30, 33, 28, 37,
# 86, 16, 10, 45, 64, 71, 78, 66, 8, 82, 43]