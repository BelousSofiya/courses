...
print(solve_quadric_equation(1, 3, -4))#Expect The solution are x1=(-4+0j) and x2=(1+0j)

print(solve_quadric_equation(1, 4, 5))#Expect The solution are x1=(-2-1j) and x2=(-2+1j)

print(solve_quadric_equation(0, 5, 9))#Expect Zero Division Error

print(solve_quadric_equation("a", 3, 1))#Expect Could not convert string to float